...
class CNN3D(nn.Module):
    def __init__(self, width=48, height=48, frames=100, in_channels=3, out_features=2, drop_p=0.2, fc_hidden1=256, fc_hidden2=128):
        super().__init__()
        ...
        self.fc3 = nn.Linear(self.fc_hidden2, self.out_features)  # fully connected layer, output = multi-classes
